...
const todayStr = new Intl.DateTimeFormat('en-CA', { timeZone: 'America/Argentina/Buenos_Aires' }).format(d);
...
console.log('Today in BA (Manual Offset):', manualBADate.toISOString().split('T')[0]);
