        ...
        >
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    name="sport"
                    value={editModalState.value.sport || "Fútbol"}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="surface"
                    value={editModalState.value.surface || "Sintético"}
          ...
          <div class="bg-slate-50 rounded-[2rem] p-6 border border-slate-200 space-y-4">
            <div class="flex items-center gap-2 mb-2">
              ...
              <h3 class="text-sm font-black text-slate-800 uppercase tracking-widest">Finanzas Base</h3>
            </div>
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="1"
                    class="w-full pl-8 pr-4 py-3 bg-white border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all font-bold"
                  />
                </div>
              </div>

              <div class="bg-white border border-emerald-100 rounded-2xl p-4 shadow-sm">
                <label class="block text-xs font-black text-emerald-600 uppercase tracking-widest mb-2">Seña requerida</label>
                <div class="flex gap-2 mb-3">
                  <button
                    type="button"
                    onClick$={() => { if (editModalState.value) editModalState.value = { ...editModalState.value, depositType: "PERCENTAGE" }; }}
                    class={["flex-1 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all", editModalState.value.depositType === "PERCENTAGE" ? "bg-emerald-600 text-white" : "bg-slate-50 text-slate-500 border border-slate-100"]}
                  >% %</button>
                  <button
                    type="button"
                    onClick$={() => { if (editModalState.value) editModalState.value = { ...editModalState.value, depositType: "FIXED" }; }}
                    class={["flex-1 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all", editModalState.value.depositType === "FIXED" ? "bg-emerald-600 text-white" : "bg-slate-50 text-slate-500 border border-slate-100"]}
                  >$ Fijo</button>
                </div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    class="w-full pl-8 pr-3 py-2.5 bg-emerald-50/50 border border-emerald-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all font-bold text-emerald-900"
                  />
                </div>
              </div>
            </div>
